...
deepspeed llava/train/train_xformers.py \
    ...
    --bf16 False \
    --output_dir ${BASE_PATH}/checkpoints/llava_lora_vision_flan_lora_ours_3000_prune_${PRUNE_RATIO}_v1.5 \
    --num_train_epochs 1 \
    ...
    --report_to wandb \
    --run_name llava_lora_vision_flan_lora_ours_3000_prune_${PRUNE_RATIO}_v1.5 \
    --prune_indices ${BASE_PATH}/COINCIDE_train/playground/data/vision-flan_191-task_1k/ours_3000_${PRUNE_RATIO}.npy \
    --prune_p $PRUNE_RATIO \
    --prune_subset "bottom" \
