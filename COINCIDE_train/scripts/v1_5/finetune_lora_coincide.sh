...
deepspeed llava/train/train_xformers.py \
    ...
    --bf16 False \
    --output_dir ${BASE_PATH}/checkpoints/llava_lora_tinyllava_ours_37111519_mmd_transfer_mod_density_prune_${PRUNE_RATIO}_v1.5 \
    --num_train_epochs 1 \
    ...
    --report_to wandb \
    --run_name llava_lora_tinyllava_ours_37111519_mmd_transfer_mod_density_prune_${PRUNE_RATIO}_v1.5 \
    --prune_indices ${BASE_PATH}/COINCIDE_train/playground/data/TinyLLaVA-Instruction/ours_37111519_indices_mmd_trans_mod_density_${PRUNE_RATIO}.npy \
    --prune_p $PRUNE_RATIO \
    --prune_subset "bottom" \
