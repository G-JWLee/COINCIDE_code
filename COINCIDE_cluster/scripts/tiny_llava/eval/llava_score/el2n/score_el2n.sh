...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python tinyllava/eval/score/el2n/score_el2n.py \
        ...
        --score_path ${BASE_PATH}/COINCIDE_train/playground/data/TinyLLaVA-Instruction/el2n_scores \
        --num-chunks $CHUNKS \
        --chunk-idx $IDX \
        --is_multimodal \
        --batch_size 4 \
...
python tinyllava/eval/score/sort_values.py \
    --score_path ${BASE_PATH}/COINCIDE_train/playground/data/TinyLLaVA-Instruction/el2n_scores.npy \
    --save_path ${BASE_PATH}/COINCIDE_train/playground/data/TinyLLaVA-Instruction/el2n_indices.npy \
